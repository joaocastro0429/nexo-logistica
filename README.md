...
Para publicar uma demonstração acessível pela internet, consulte a configuração
do frontend na Vercel e do backend em [Deploy público](docs/deploy.md).
A configuração local abaixo usa
